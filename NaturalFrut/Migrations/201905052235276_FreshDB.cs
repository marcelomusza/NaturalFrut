                ...
                c => new
                    {
                        ...
                        Provincia = c.String(),
                        Localidad = c.String(),
                        TelefonoNegocio = c.Int(),
                        TelefonoCelular = c.Int(),
                        Debe = c.Double(),
                        SaldoAfavor = c.Double(),
                        Email = c.String(),
                        CondicionIVAId = c.Int(),
                        TipoClienteId = c.Int(),
                        ListaId = c.Int(),
                        Transporte = c.String(),
                        DireccionTransporte = c.String(),
                        TelefonoTransporte = c.Int(),
                        Dias = c.String(),
                        Horarios = c.String(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.CondicionIVAs", t => t.CondicionIVAId)
                .ForeignKey("dbo.Listas", t => t.ListaId)
                .ForeignKey("dbo.TipoClientes", t => t.TipoClienteId)
