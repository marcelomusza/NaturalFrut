namespace NaturalFrut.Migrations
{
    ...
    public partial class merge_repair : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.VentasMayoristas", t => t.VentaID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Fecha = c.DateTime(nullable: false),
                        ImporteVentaTotal = c.Decimal(nullable: false, precision: 18, scale: 2),
